...
Client.prototype.setCustomHeaders = function(custom_headers) {
...
Client.prototype._invoke = function(method, args, location, callback, options) {
    var self = this,
		...
		for (var attr in this.custom_headers) { headers[attr] = this.custom_headers[attr]; }
	    // console.log(xml);
